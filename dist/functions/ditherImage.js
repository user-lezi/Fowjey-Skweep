...
exports.default = new forgescript_1.ForgeFunction({
    ...
    brackets: true,
    params: [
        { name: "imageurl", type: forgescript_1.ArgType.URL, required: true },
        { name: "path", type: forgescript_1.ArgType.String, required: true },
        { name: "mode", type: forgescript_1.ArgType.String },
        { name: "palette", type: forgescript_1.ArgType.String },
        { name: "size", type: forgescript_1.ArgType.Number },
    ],
    code: `
